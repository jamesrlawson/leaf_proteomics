...
blah <- read.fasta('data/sequences/Egrandis_Eglobulus_chloroplast_Myrtales_At_mt_cRAP_160405.fasta', seqtype='AA', as.string=TRUE, strip.desc=TRUE)

EGrandis_AA_seqs <- data.frame(do.call(rbind, blah))

write.csv(EGrandis_AA_seqs, 'data/sequences/Egrandis_Eglobulus_chloroplast_Myrtales_At_mt_cRAP_160405.csv')
...
write_csv(D14_euc_AA_seqs, 'data/sequences/Egrandis_Eglobulus_chloroplast_Myrtales_At_mt_cRAP_160405_D14eucSubset.csv')
